...
class EmployeeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Employee entity")
        ...
        .repeat(2) {
            ...
            .get("/linemanufacturing/api/employees")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new employee")
            .post("/linemanufacturing/api/employees")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/linemanufacturing${new_employee_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created employee")
            .delete("/linemanufacturing${new_employee_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
