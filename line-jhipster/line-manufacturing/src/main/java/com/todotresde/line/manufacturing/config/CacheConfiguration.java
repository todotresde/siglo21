...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.setInstanceName("lineManufacturing");
        ...
        config.getMapConfigs().put("com.todotresde.line.manufacturing.domain.*", initializeDomainMapConfig(jHipsterProperties));
