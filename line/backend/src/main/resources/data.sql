...
-- Volcando datos para la tabla line.delay_type: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `delay_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `delay_type` ENABLE KEYS */;

-- Volcando datos para la tabla line.line: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla line.line_work_station_configurations: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla line.product: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla line.product_type: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `product_type` DISABLE KEYS */;
INSERT INTO `product_type` (`id`, `code`, `description`, `name`) VALUES
	(9150849, '002', 'Sistema', 'Sistema'),
	(70086131, '003', 'Motor', 'Motor'),
	(74239740, '001', 'Tela', 'Tela');
...
-- Volcando datos para la tabla line.work_station_configuration: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla line.work_station_configuration_product_types: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla line.work_station_configuration_users: ~4 rows (aproximadamente)
